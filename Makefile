...
download-openapi:
	...
	curl -o original_openapi.yaml $(DOWNLOAD_OPENAPI_URL)
...
build: ## Build the Swift package
	@echo "$(YELLOW)Building MistralAPI...$(RESET)"
	swift build
	@echo "$(GREEN)Build complete!$(RESET)"

test: ## Run tests for the package
	@echo "$(YELLOW)Running tests for MistralAPI...$(RESET)"
	swift test
